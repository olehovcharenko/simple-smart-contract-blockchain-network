const { Block } = require("./app");

function zhozscript(input, storage, balance, userArgs, address, blockInfo, contractAddress, disableLogging = false) {
    ...
    switch (command) {
        ...
        case "timestamp":
            ...
            break;
        case "difficulty":
            memory[args[0]] = block.ifo.difficulty;
            break;
        case "store":
